...
export function buildDesktopSelfKnowledgeSkillContent(): string {
  return [
    ...
    '',
    'Desktop records an `htmlAudit` summary for saved HTML Artifacts. It marks whether the HTML is self-contained, whether runtime approval is required, and which external resources or Desktop Bridge capabilities were detected. Desktop also writes runtime authorization records back to Artifact metadata when a user grants or denies Desktop Bridge access.',
    '',
