...
export function buildDesktopSelfKnowledgeSkillContent(): string {
  return [
    ...
    '',
    'The first P0 card set should cover authorization cards, Artifact cards, and ActionRun result cards. Authorization cards show risk, requested capability, approve/deny details, and audit clues. Artifact cards show title, type, preview/open actions, save/import/mirror state, source work item, and value health. ActionRun result cards show status, result summary, approval state, generated Artifacts, and next actions such as preserve output, update knowledge, or write review.',
    '',
