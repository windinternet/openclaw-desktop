...
- Projects：项目实体层。它通常是一组项目目录或项目 README/brief，能让 UI 像“项目可视化”一样展示项目卡片。一个项目可以包含背景、目标、状态、链接、资料、产出或待知识化说明。例如 20-projects/_/README.md、clients/_/brief.md、initiatives/\* 都可以是项目实体。项目目录里的 plan.md、log.md、README.md 是项目资料，不是看板事项。
